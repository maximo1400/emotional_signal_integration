...
class VAClassifier:
    ...
    def predict(self, pow_vector: List[float]) -> Dict:
        ...
        beta_indices = [i for i, col in enumerate(self.POW_COLUMNS) if "betaL" in col or "betaH" in col]
        ...
        left_frontal = [i for i, col in enumerate(self.POW_COLUMNS) if "F3" in col or "AF3" in col]
        right_frontal = [i for i, col in enumerate(self.POW_COLUMNS) if "F4" in col or "AF4" in col]
